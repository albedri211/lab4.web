...
<body>
    <div id="container">
        ...
        <section id="introduce">
            <div class="row">
                <h1>Perkenalkan!</h1>
                <p>saya Muhammad Albedri. Saya adalah seorang mahasiswa dari <i>Universitas Pelita Bangsa</i> yang saat ini sedang mempelajari materi Layout CSS dalan mata kuliah <i>Pemrograman Web</i>.</p>
                    <a href="about.html" class="btn btn-large">Learn more &raquo;</a>
            </section>
        </div>
</body>
</html>
